...
const STEPS: Step[] = [
  ...
  { id: "queries",  label: "Generating 10 buyer queries",          activeAt: 4,  doneAt: 12 },
  { id: "llm-a",   label: "Querying Llama 3.3 (70B)",             activeAt: 12, doneAt: Infinity },
  { id: "llm-b",   label: "Querying Llama 3.1 (8B)",              activeAt: 12, doneAt: Infinity },
  { id: "llm-c",   label: "Querying Gemini",                      activeAt: 12, doneAt: Infinity },
  { id: "score",   label: "Scoring responses",                    activeAt: 55, doneAt: Infinity },
  { id: "recs",    label: "Generating recommendations",           activeAt: 58, doneAt: Infinity },
];

const ESTIMATED_TOTAL = 65; // seconds
